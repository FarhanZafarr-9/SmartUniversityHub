...
import StudentAssessments from '../StudentPages/StudentAssessments';
import FacultyAssessments from '../FacultyPages/FacultyAssessments';
...
const DefaultAssessments = () => {
    ...
    switch (userData.user.user_type.toLowerCase()) { // Case-insensitive check
        case 'student':
            return <StudentAssessments user={userData.user} />;
        case 'faculty':
            return <FacultyAssessments user={userData.user} />;
        case 'admin':
