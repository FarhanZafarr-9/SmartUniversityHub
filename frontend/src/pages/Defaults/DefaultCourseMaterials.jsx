...
import StudentCourseMaterials from '../StudentPages/StudentCourseMaterials';
import FacultyCourseMaterials from '../FacultyPages/FacultyCourseMaterials';
...
const DefaultCourseMaterials = () => {
    ...
    switch (userData.user.user_type.toLowerCase()) { // Case-insensitive check
        case 'student':
            return <StudentCourseMaterials user={userData.user} />;
        case 'faculty':
            return <FacultyCourseMaterials user={userData.user} />;
        case 'admin':
...
export default DefaultCourseMaterials;